...
<td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';max-width:100vw;padding:32px"><font color="#550055">
      ...
      <p>
        Dear Member Your order number {{ $order_id }} Status Has Beeen Changed...!

   <p>
       {{ $orderdetial }} Order is @if($order_status=='on')Confirmed  @else Pendding @endif Please vist our site ...! please click  <a href="{{ $app_url }}">here</a> 
    </p>
