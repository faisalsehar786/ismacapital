...
<img src="{{ $logo }}" srcset="{{ $logo }}" alt="Laravel Logo" style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';max-width:100%;border:none;height:75px;width:75px">
</a>
</td>
</tr>
<tr>
...
<p>
    	Dear User Congratulation now you are Member of ismcapitals.The Details are give below..!
    </p>
 ...
 <p style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
   ...
   User Ref Id:  <strong>{{$user_ref }}</strong>
