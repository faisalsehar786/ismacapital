...
<div class="col-md-12">
<h2></h2>
<form action="{{ route('confirm_order') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="paymentVal" value="{{ $order_data['paymethod'] }}">

<input type="hidden" name="hidden_commission_fee" value='@php
    echo CH::Get_Latest_Commision()->transaction_fee_sell;
@endphp'>
...
<input type="hidden" name="hidden_recived_amount" value='@php
                   ...
                   $bitcoin_value=Session::get('convertedAmount');
                    ...
                    $transaction_fee_sell=CH::Get_Latest_Commision()->transaction_fee_sell;
                           

                    $total_value_of_bitcoin=$bitcoin_value;

                    $commission_fee=($total_value_of_bitcoin)*($transaction_fee_sell/100);
...
<tr>
<td colspan="2"><h1 style="text-align: center;font:bold;">Send {{ Session::get('coinType') }} to this</h1></td>
</tr>
<tr>
<td><strong style="font:bold;font-size:18px">Wallet Address</strong></td>
<td style="font:bold;font-size:18px;" class="thumbnail"><span class="shadow-lg p-2 border-0 text-success"><b>bc1qs3ry3zckuar7z26ps0xe9fdk8xj8wp29cm3u32</b></span></td>
<input type="hidden" name="wallet_address" value="bc1qs3ry3zckuar7z26ps0xe9fdk8xj8wp29cm3u32">
</tr>
<tr>
<td style="font:bold;font-size:18px"><b>Amount in {{ Session::get('coinType') }}</b></td>
...
<td style="font:bold;font-size:18px;">&nbsp;&nbsp;&nbsp;&nbsp;<img src="{{ asset('bc1qs3ry3zckuar7z26ps0xe9fdk8xj8wp29cm3u32.jpeg') }}" height="180px" width="200px" class="img-thumbnail shadow-lg p-2" style="border:1px solid black">
</td></tr>
<tr>
</tr><tr>
...
<tr>
<td style="font:bold;font-size:18px"><b>Transaction ID /Url</b>
</td>
...
echo Session::get('finalbtcVal');
                           // echo $bitcoin_current_val=CH::Get_Latest_Bitcoin_value()[0]->price+
                           //  CH::Get_Latest_Additional_price()[0]->cryptocurrency_additional_sell_price;

   // $bitcoin_current_val=Session::get('convertedAmount')+CH::Get_Latest_Additional_price()->cryptocurrency_additional_sell_price;

   // $coinCurrentVal=$bitcoin_current_val-CH::Get_Latest_Additional_price()->cryptocurrency_decremental_sell_price;
     
            echo "<input type='hidden' name='bitcoin_current_val' value='".Session::get('finalbtcVal')."'>";                
...
<td style="font:bold;font-size:18px">&nbsp;&nbsp;&nbsp;&nbsp;<b>@php
                           ...
                           //  CH::Get_Latest_Additional_price()[0]->cryptocurrency_additional_sell_price)*$order_data['reqData']['bitcoin_entered_amount']);


// $convertedAmount=Session::get('convertedAmount')+CH::Get_Latest_Additional_price()->cryptocurrency_additional_sell_price;
//   echo (($convertedAmount-CH::Get_Latest_Additional_price()->cryptocurrency_decremental_sell_price)*$order_data['reqData']['bitcoin_entered_amount']);
