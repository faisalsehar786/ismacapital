					...
					<div class="box-content">
						...
						<form class="form-horizontal" action="{{URL::to('/update-order-value',$data->id)}}" method="post">
						  <fieldset>
							...
							<div class="control-group">
							  <label class="control-label" for="date01"><b>Order Email</b></label>

							  <div class="controls">
								<input type="text" class="form-control" name="order_number" value="{{ $data->order_email }}" required>
							  </div>
							...
							<div class="control-group">
							  <label class="control-label" for="date01"><b>Buyer Wallet Address</b></label>

							  <div class="controls">
								<input type="text" class="form-control" name="reciver_wallet_address" value="{{ $data->reciver_wallet_address }}" >
							  </div>
							...
							<div class="control-group">
							  <label class="control-label" for="date01"><b>Buy {{ $data->coinType }}</b></label>

							  <div class="controls">
								<input type="text" class="form-control" name="recived_bitcoin" value="{{ $data->recived_total_amount}}" required readonly="">
							  </div>
							...
							<div class="control-group">
							  <label class="control-label" for="date01"><b>{{ $data->coinType }} Current Value</b></label>
							...
							<div class="control-group">
							  <label class="control-label" for="date01"><b> Buy {{ $data->coinType }} Total</b></label>
							...
							<div class="control-group">
                              ...
                              <select name="status"  class="form-control statusc" >
                                 ...
                                 <option value="on" selected="">Done</option>
