...
<label class="bg-warning rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid #BC873C;">Step 1</label> --------<i class="arrow right"></i><br>
<strong>How to Buy</strong><br>
Enter the amount you want to buy > select coin > select currency > select payment method
</div>
 </div> 
 <div class="col-md-4">
<div class=" p-1 " style="color:#BC873C;">

<label class="bg-warning rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid #BC873C;">Step 2</label> --------<i class="arrow right"></i><br>
<strong>Make Payment</strong><br>
Make a bank transfer or cash deposit to our provided bank account
</div>
 </div> 
 <div class="col-md-4">
<div class=" p-1" style="color:#BC873C;">

<label class="bg-warning rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid #BC873C;">Step 3</label> --------<i class="arrow right"></i><br>
<strong>Wallet Address</strong><br>
Provide your Wallet Address to receive BTC
</div>
 </div> 
 <div class="col-md-4">
<div class=" p-1" style="color:#BC873C;">

<label class="bg-warning rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid #BC873C;">Step 4</label> --------<i class="arrow right"></i><br>
<strong>Upload Payment Screenshot</strong><br>
Upload bank transfer or cash deposit payment screenshot for confirmation
</div>
 </div> 
 <div class="col-md-4">
<div class=" p-1 " style="color:#BC873C;">

<label class="bg-warning rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid #BC873C;">Step 5</label> --------<i class="arrow right"></i><br>
<strong>Receive BTC</strong><br>You will receive BTC as soon as your payment has been confirmed
</div>
 </div> 
</div>
