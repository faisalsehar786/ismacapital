...
<h4 class="text-white">Blog / {{ $blog->title }}</h4>
...
<p class="text-success"> <strong>{{ date('d M Y', $blog->created_at->timestamp) }} </strong></p>

</div>
<div class="col-md-10">
<h4 class="pb-1"> <strong>{{ $blog->title }}</strong></h4>
<img src="{{ asset('img') }}/{{ $blog->image }}" alt="" class="img-fluid img-thumbnail my-2" />
<p class="pb-1">{!! $blog->des !!}</p>
<div> 
</div>
