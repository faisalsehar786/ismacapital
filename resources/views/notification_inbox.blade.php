...
@endphp
    @php
            $orderData=App\Recived_Orders::where('id',$order_id)->first();

           App\Recived_Orders::where('id',$order_id)->update(['view_user'=>'yes']);
        @endphp
@endsection
@section('content')
<div class="container my-5">
      ...
      <div class="col-lg-4 pb-5 "> 
            ...
            <div class="wizard  bg-white">
                ...
                <nav class="list-group list-group-flush shadow-sm    bg-white rounded">
                     ...
                     Order No: {{ $orderData->order_number }}</div>
                     ...
                     @if ($orderData->status=='on')
                      <label class="badge-success badge shadow-lg border-0">Confirmed</label>
                     @else
                  <label class="badge-danger badge shadow-lg border-0">Pending</label>
                     @endif
                     </div>
                     ...
                     @if ($orderData->status=='on')
                      ...
                      Give Feed Back: <a href="{{ route('giveReview',['orderId'=>$orderData->id]) }}" class="btn btn-success shadow-lg border-0 btn-sm"> 
                      Review</a></div>
                     @endif
        ...
        <div class="col-lg-8 pb-5">
            ...
            <div class="row  shadow-sm p-3  bg-white rounded" >
                @csrf
                <div class="col-md-12" style="border: 1px solid #695e5e;
    border-radius: 6px;">
    ...
    <li class="list-group-item d-flex justify-content-between align-items-center">
      Coin Type
       ...
       <p>{{ $orderData->coinType }}</p>
   
    </li>
     <li class="list-group-item d-flex justify-content-between align-items-center">
      Coin Value
      <p>{{ $orderData->bitcoin_current_val }}</p>
    </li>
 ...
 @endif
  ...
  @if ($orderData->ordertype=='buy')
    ...
    <li class="list-group-item d-flex justify-content-between align-items-center">
     ...
     <li class="list-group-item d-flex justify-content-between align-items-center">
     Currency
    <p>{{ $orderData->convertedCurrency }}</p>
    </li>

     <li class="list-group-item d-flex justify-content-between align-items-center">
     Transection URL
       <p>{{ $orderData->transection_url }}</p>
    </li>

     <li class="list-group-item d-flex justify-content-between align-items-center">
   Commission Fee

       <p>{{ $orderData->commission_fee }}</p>
    </li>

     <li class="list-group-item d-flex justify-content-between align-items-center">
   {{ $orderData->ordertype }} {{ $orderData->coinType }}

       <p>{{ $orderData->recived_total_amount }}</p>
    </li>
    ...
    Wallet Address
       ...
       <p>{{ $orderData->reciver_wallet_address }}</p>
    </li>
     ...
     <li class="list-group-item d-flex justify-content-between align-items-center">
    Invoice
    <a href="{{ asset('invoice') }}/{{ $orderData->invoice }}">Invoice</a>
    </li>

     <li class="list-group-item d-flex justify-content-between align-items-center">
    Payment Method

    @if ($orderData->payment_method=='bTransfer')
    ...
    @if ($payment_method=='bTransfer')
                                            <div class='control-group'>
                                            <label class='control-label' for='date01'><b>Bank Name</b></label>

                                            <div class='controls'>
                                                <input type='text' class='input-xlarge' name='bTransfer_bank_name' value='{{ $orderData->bTransfer_bank_name }}' required>
                                            </div>
                               ...
                               <div class='control-group'>
                                            ...
                                            <div class='controls'>
                                        <input type='text' class='input-xlarge' name='bTransfer_account' value='{{ $orderData->bTransfer_account }}' required>
                                            </div>
                              ...
                              <div class='control-group'>
                                            ...
                                            <div class='controls'>
                                                <input type='text' class='input-xlarge' name='bTransfer_ac_name' value='{{ $orderData->bTransfer_ac_name }}' required>
                                            </div>
                                ...
                                <div class='control-group'>
                                            ...
                                            <div class='controls'>
                                                <input type='text' class='input-xlarge' name='bTransfer_ref' value='{{ $orderData->bTransfer_ref }}' required>
                                            </div>
    ...
    @else
                                            ...
                                            <div class='controls'>
                                                <input type='text' class='input-xlarge' name='cashDeposit_bank_name' value='{{ $orderData->cashDeposit_bank_name }}' required>
                                            </div>
                                ...
                                <div class='control-group'>
                                            ...
                                            <div class='controls'>
                                                <input type='text' class='input-xlarge' name='cashDeposit_account' value='{{ $orderData->cashDeposit_account}}' required>
                                            </div>
                                ...
                                <div class='control-group'>
                                            ...
                                            <div class='controls'>
                                                <input type='text' class='input-xlarge' name='cashDeposit_ac_name' value='{{$orderData->cashDeposit_ac_name  }}' required>
                                            </div>
                                ...
                                <div class='control-group'>
                                            ...
                                            <div class='controls'>
                                                <input type='text' class='input-xlarge' name='bTransfer_ref' value='{{ $orderData->cashDeposit_ref }}' required>
                                            </div>
