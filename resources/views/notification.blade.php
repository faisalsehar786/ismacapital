...
<div class="container my-5">
    ...
    <div class="row">
       ...
       <h4 class="text-success text-center py-3">Notifications</h4>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="btn-group">
                        ...
                        Status&nbsp;&nbsp;<span class="caret"></span><span class="sr-only">Toggle Dropdown</span>
                        </button>
                        <ul class="dropdown-menu" role="menu">
                            <li  class="dropdown-item"><a href="{{ route('notification',['search'=>'inbox']) }}">All</a></li>
                            <li  class="dropdown-item"><a href="{{ route('notification',['search'=>'read']) }}">Read</a></li>
                            <li  class="dropdown-item"><a href="{{ route('notification',['search'=>'unread']) }}">Unread</a></li>
                            <li  class="dropdown-item"><a href="{{ route('notification',['search'=>'confirmed']) }}">Confirmed</a></li>
                           <li  class="dropdown-item"><a href="{{ route('notification',['search'=>'pending']) }}">Pending</a></li>
                            
                        </ul>
                    </div>
                    <a href="{{ route('notification',['search'=>'inbox']) }}" class="btn btn-light" data-toggle="tooltip" title="Refresh">
            ...
            <hr>
             <div class="row">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="{{ route('notification',['search'=>'inbox']) }}">inbox &nbsp; <i class="fa fa-user" aria-hidden="true"></i></a>
                    </li>
                    
                </ul>
                <div class="tab-content">
                
                            <div id="menu1" class=" tab-pane  active" style="background: aliceblue">
                                <button type="button" class="btn btn-warning shadow-lg my-3 mx-2 btn-sm">
                                Unread Messages &nbsp;&nbsp;<span class="badge bg-danger ms-2 conternote" >{{ $ordercount }}</span>
                                </button>
                                @foreach ($orders as $element)
                                    {{-- expr --}}
                              
                                <a href="{{ route('ShowFreshNotification',['id'=>$element->id]) }}" class="list-group-item border-0 " style="background:@if($element->view_user=='yes')aliceblue @endif;">

                                    <span class="name  label label-warning" style="min-width: 150px;
                                        display: inline-block;">{{ Auth::user()->name }}</span>

                                         <span class="">
                                New order no {{ $element->order_number }} and Coin {{ $element->coinType }} has been {{ $element->ordertype}}
                                        </span>
                                  

                                        
                                          <span class="@if($element->status=='yes')badge badge-success @else badge badge-danger  @endif float-right">
                                           <?php echo \Carbon\Carbon::createFromTimeStamp(strtotime($element->created_at))->diffForHumans() ?>
